...
console.log(crearGato("Piskero",23));
...
console.log(nuevoUsuario("sebas","sebastian@gmail.com","lkjdsf"))
...
console.log(tieneEmail({user:"sebastian",email:"sebasb"}))
...
console.log(agregarAmigo(objetoUsuario, "pedro"))
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function ( ){
    ...
    const valorFinal = this.precio - descuento;
